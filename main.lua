...
local buttons={
	{ label = "AC",  doublew = false, bg = {188,189,191}, txt = {0,0,0}},
	{ label = "+/-", doublew = false, bg = {188,189,191}, txt = {0,0,0}},
	{ label = "%",   doublew = false, bg = {188,189,191}, txt = {0,0,0}},
	{ label = "/",   doublew = false, bg = {243,123,17},  txt = {255,255,255}},
	{ label = "7",   doublew = false, bg = {195,197,200}, txt = {0,0,0}},
	{ label = "8",   doublew = false, bg = {195,197,200}, txt = {0,0,0}},
	{ label = "9",   doublew = false, bg = {195,197,200}, txt = {0,0,0}},
	{ label = "X",   doublew = false, bg = {243,123,17},  txt = {255,255,255}},
	{ label = "4",   doublew = false, bg = {195,197,200}, txt = {0,0,0}},
	{ label = "5",   doublew = false, bg = {195,197,200}, txt = {0,0,0}},
	{ label = "6",   doublew = false, bg = {195,197,200}, txt = {0,0,0}},
	{ label = "-",   doublew = false, bg = {243,123,17},  txt = {255,255,255}},
	{ label = "1",   doublew = false, bg = {195,197,200}, txt = {0,0,0}},
	{ label = "2",   doublew = false, bg = {195,197,200}, txt = {0,0,0}},
	{ label = "3",   doublew = false, bg = {195,197,200}, txt = {0,0,0}},
	{ label = "+",   doublew = false, bg = {243,123,17},  txt = {255,255,255}},
	{ label = "0",   doublew = true,  bg = {195,197,200}, txt = {0,0,0}},
	{ label = ".",   doublew = false, bg = {195,197,200}, txt = {0,0,0}},
	{ label = "=",   doublew = false, bg = {243,123,17},  txt = {255,255,255}}
};
...
for i = 1, #buttons do --Go over all buttons in our config table
    ...
    tmpButton:addEventListener( "touch", buttonTouch );
